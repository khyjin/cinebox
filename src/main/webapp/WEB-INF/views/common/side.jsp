...
<c:otherwise>
	<li>
		...
		<ul>
			...
			<li><a href="${contextPath}/goods/goodslist1.do">경제/경영</a></li>
			<li><a href="${contextPath}/goods/goodslist2.do">대학교재</a></li>
			<li><a href="${contextPath}/goods/goodslist3.do">자기계발</a></li>
			<li><a href="${contextPath}/goods/goodslist4.do">자연과학/공학</a></li>
			<li><a href="${contextPath}/goods/goodslist5.do">역사/인문학</a></li>
		</ul>
	</li>
	<li>
		<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;음반</h3>
...
<DIV id="notice">
	...
	<c:forEach  var="i" begin="1" end="5" step="1">
		<li><a href="${contextPath}/main/notice.do">공지사항입니다.${i}</a></li>
	</c:forEach>
	</ul>
</div>
