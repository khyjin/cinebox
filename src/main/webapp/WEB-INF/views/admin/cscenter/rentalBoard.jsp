			...
			<tbody>
				...
				<c:forEach items="${list}" var="list">
					<tr>
						...
						<td><a class="btitle2" href="${contextPath}/admin/cscenter/rental_view.do?cscenter_number=${list.cscenter_number}">
							[${list.cscenter_headline}] &nbsp; ${list.cscenter_title}</a></td>
						<td>${list.member_id}</td>
						<td><fmt:formatDate value="${list.cscenter_reg_date}" pattern="yyyy/MM/dd HH:mm:ss" /></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
