         ...
         <tr>
             <td colspan=8 class="fixed">
		         ...
		         <c:if test="${chapter >1 && page==1 }">
		          <a href="${contextPath}/admin/order/adminOrderMain.do?chapter=${chapter-1}&pageNum=${(chapter-1)*10 +1 }">&nbsp;&nbsp;</a>
		         </c:if>
		          <a href="${contextPath}/admin/order/adminOrderMain.do?chapter=${chapter}&pageNum=${page}">${(chapter-1)*10 +page } </a>
		         <c:if test="${page ==10 }">
		          <a href="${contextPath}/admin/order/adminOrderMain.do?chapter=${chapter+1}&pageNum=${chapter*10+1}">&nbsp; next</a>
		         </c:if> 
	      		</c:forEach> 
           </td>
        </tr>  		   
