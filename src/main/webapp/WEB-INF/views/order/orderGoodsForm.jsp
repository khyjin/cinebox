   ...
   <table class="list_view" id="list">
      <tbody align=center>
    	 ...
    	 <td rowspan="6" class="goods_image" style="padding-right:50px; padding-left:20px;">
             <img width="175" alt=""  src="${contextPath}/thumbnails.do?movie_id=${list.movie_id}&fileName=${item.movie_fileName}">
         ...
         <tbody>
            <tr>
               <td>
                  ...
                  <input type="radio" id="ticket_pay_method" name="ticket_pay_method" value="실시간 계좌이체" onClick="fn_pay()">실시간 계좌이체 &nbsp;&nbsp;&nbsp;
                  <input type="radio" id="ticket_pay_method" name="ticket_pay_method" value="휴대폰결제" onClick="fn_pay_phone()">휴대폰 결제 &nbsp;&nbsp;&nbsp;
                  <input type="radio" id="ticket_pay_method" name="ticket_pay_method" value="카카오페이(간편결제)" onClick="fn_pay()">카카오 페이 &nbsp;&nbsp;&nbsp; 
                  <input type="radio" id="ticket_pay_method" name="ticket_pay_method" value="무통장 입금" onClick="fn_pay_account()">무통장 입금 &nbsp;&nbsp;&nbsp;
