...
public class GoodsVO {
	...
	private String goods_sort; // 상품 종류 (중분류)
	private int    goods_sales_price; // 상품판매가격 
	private int    goods_point; //상품포인트
	private Date    goods_published_date; // 상품 런칭일
	private int    goods_total_page; // 상품 페이지
	private String goods_isbn; // 일련 번호
	private String goods_delivery_price; // 배송비
	private Date goods_delivery_date; // 상품배송일
	private String goods_fileName; // 이미지 파일
	private String goods_status; // 상품분류
	private String goods_writer_intro; // 상품 소개
	private String goods_contents_order; // 상품 목차
	private String goods_intro; // 저자 소개
	private String goods_publisher_comment; // 출판사 서평
	private String goods_recommendation; // 상품 추천사
	private Date   goods_credate; // 상품 입고 일
