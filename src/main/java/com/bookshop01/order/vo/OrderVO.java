...
public class OrderVO {
	private int order_seq_num; //주문 일련번호
	private String member_id; //회원(주문자) 아이디
	private int order_id; // 주문 번호
	private int goods_id; // 상품 번호
	private String goods_title; // 상품명
	private int goods_sales_price; // 상품 판매 금액
	private int total_goods_price; // 상품 원가
	...
	private String receiver_hp1; //수령자 휴대폰 번호 1
	private String receiver_hp2; //수령자 휴대폰 번호 2
	private String receiver_hp3; //수령자 휴대폰 번호 3
	private String receiver_tel1; //수령자 유선전화 1
	private String receiver_tel2; //수령자 유선전화 2
	private String receiver_tel3; //수령자 유선전화 3
	...
	private String pay_method; //결재방법
	private String card_com_name; //결재카드회사이름
	private String card_pay_month; //할부개월수
	private String pay_orderer_hp_num; //휴대폰 결제 전화번호
	private String pay_order_time; //상품배송상태
	private String delivery_state;  //현재 주문 상품 배송 상태
	
	private String final_total_price; // 총 결제 금액
	private int goods_qty; //상품 수
	private String goods_fileName; //상품 이미지
	private String orderer_hp; //주문 상황
